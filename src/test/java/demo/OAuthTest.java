...
//        WebDriver driver= new ChromeDriver();
        ...
        driver.findElement(By.cssSelector("[type='email']")).sendKeys("gopirajsathwika1999@gmail.com");
        driver.findElement(By.cssSelector("[type='email']")).sendKeys(Keys.ENTER);
        Thread.sleep(3000);
        driver.findElement(By.cssSelector("[type='password']")).sendKeys("sathWIKA@20");
